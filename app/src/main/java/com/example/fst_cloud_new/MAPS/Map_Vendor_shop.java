...
public class Map_Vendor_shop extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_vendor);


        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_vendor);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Shop Location");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    mMap.addMarker(new MarkerOptions().position(latLng).title(location_name.getText().toString()));
                    mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
                    //       location_name.setText(null);
