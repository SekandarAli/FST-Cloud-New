...
class Vendor_Shop_Category_Add_Data : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vendor_shop_category_add_data)
        ...
        vendor_dish_name = findViewById(R.id.vendor_shop_item_name)
        vendor_dish_description = findViewById(R.id.vendor_shop_item_description)
        vendor_dish_price = findViewById(R.id.vendor_shop_item_price)
        ...
        show_data.setOnClickListener {
            ...
            var intent = Intent(this, Vendor_Shop_Category_Show_Data::class.java)
            startActivity(intent)
    ...
    fun Add_Data() {
        ...
        reference = root_Node!!.getReference("Shopmain")

        var shop_main_name  = vendor_dish_name.text.toString()
        var shop_main_description = vendor_dish_description.text.toString()
        var shop_main_price = vendor_dish_price.text.toString()
        ...
        if (vendor_dish_price.text.isNullOrEmpty()) {
            ...
            val ref: StorageReference = Storageref.child("Shopmain/" + UUID.randomUUID().toString())
